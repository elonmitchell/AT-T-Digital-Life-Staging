...
define([
    ...
    'logger',
    'basemodel'
], function (Backbone, _, Logger, BaseModel) {
    'use strict';
    var BaseCollection = Backbone.Collection.extend({
        ...
        parse: function (resp, options) {
            ...
            this.findObjectByName(resp, this.dataName);

            // Mark this as RestTL data
            if (_.isArray(this.parsedData)) {
                for (arrObj in this.parsedData) {
                    if (this.parsedData.hasOwnProperty(arrObj)) {
                        this.parsedData[arrObj].restTL = true;
                    }
                }
            } else if (_.isObject(this.parsedData)) {
                this.parsedData.restTL = true;
            }
